...
interface SearchOptionManagerProps {
...
const SearchOptionManager = memo(({searchOptions, changeSearchOption, allMajors}: SearchOptionManagerProps) => {
    return (
        <div>
            <HStack spacing={4}>
                <FormControl>
            ...
            <HStack spacing={4}>
                <FormControl>
                    ...
                    >
                        ...
                        <Stack spacing={2} overflowY="auto" h="100px" border="1px solid"
...
export default SearchOptionManager;
